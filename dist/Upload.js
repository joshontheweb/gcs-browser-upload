      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 6:
            ...
            if (!(_context6.t0 instanceof Error && !_context6.t0.response)) {
              _context6.next = 12;
              break;
            }
            ...
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                uploadChunk = function () {
                  var _ref3 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(checksum, index, chunk) {
                ...
                validateChunk = function () {
                  var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(newChecksum, index) {
